...
public class UpdateSupplier extends JFrame implements ActionListener
{
 ...
 l1.setBounds(150,120,130,25);
  ...
  l5.setBounds(150,280,170,25);
	    ...
	    b0.setBounds(100,330,110,35);b0.setToolTipText("click to open supplier details");
	    jf.add(b0); b0.addActionListener(this);

		b1 = new JButton("Update",new ImageIcon("images//update.png"));
		b1.setBounds(220,330,110,35);b1.setToolTipText("click to update supplier details");
		jf.add(b1);b1.addActionListener(this);

		b2 = new JButton("Clear",new ImageIcon("images//clear.png"));
		b2.setBounds(340,330,110,35);b2.setToolTipText("click to clear all textfilds");
	    jf.add(b2);b2.addActionListener(this);

	   	b3 = new JButton("All",new ImageIcon("images//all.png"));
		b3.setBounds(460,330,110,35);b3.setToolTipText("click to view all supplier details");
		jf.add(b3); b3.addActionListener(this);

		b4 = new JButton("Back",new ImageIcon("images//all.png"));
		b4.setBounds(580,330,110,35);b4.setToolTipText("go to homepage");
...
String str1="UPDATE DDDD SET sid='"+t1.getText()+"',sname='"+t2.getText()+"',saddress='"+t3.getText()+"',sphoneno='"+t4.getText()+"',semailid='"+t5.getText()+"' where sid='"+t1.getText()+"' or sname='"+t2.getText()+"' ";
