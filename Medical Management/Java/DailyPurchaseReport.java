...
home = new JButton("Home",new ImageIcon("images//clear.png"));
    home.setBounds(480,150,110,35);home.setToolTipText("click to go to homepage");
	...
	if(ae.getSource()==submit)
     ...
     try
     {
        ...
        rs = stmt.executeQuery("SELECT sid,sname,mb,mname,mexpdate,mqty,mpurprice,msaleprice from MyDatabase where mpurdate='"+t1.getText()+"' ");
          while(rs.next())
            {
