  ...
  l9.setBounds(470,180,200,25);
   ...
   l11.setBounds(470,260,180,25);
       ...
       l12.setBounds(470,300,180,25);
		...
		b1.setBounds(220,330,110,35);b1.setToolTipText("click to delete medicine details");
	                   jf.add(b1);
	...
	b4 = new JButton("Back",new ImageIcon("images//delete.png"));
		b4.setBounds(580,330,110,35);b4.setToolTipText("click to delete medicine details");
	                   jf.add(b4);
...
public void actionPerformed(ActionEvent ae)
{
    if(ae.getSource()==b0)
	 ...
	 {//delete
		...
		con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","system");
		System.out.println("Connected to database.");
	    ps=con.prepareStatement("delete from MyDatabase where mb='"+t1.getText()+"' or mname='"+t2.getText()+"'");
	    ps.executeUpdate();
