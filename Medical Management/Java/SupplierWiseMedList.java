...
home = new JButton("Home",new ImageIcon("images//clear.png"));
    home.setBounds(480,150,110,35);home.setToolTipText("click to clear textfield");
    jf.add(home);home.addActionListener(this);


    scrlPane.setBounds(0,200,1350,600);
    jf.add(scrlPane);
	...
	if(ae.getSource()==submit)
     ...
     try
     {
        ...
        rs = stmt.executeQuery("SELECT mb,mname,mcompany,mqty,mexpdate,mpurdate,mtype,mpurprice,msaleprice,mrackno,sid,sname from MyDatabase where sname='"+t1.getText()+"' ");
          while(rs.next())
            {
