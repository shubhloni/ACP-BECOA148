 ...
 l12.setBounds(470,300,180,25);
        ...
        try
		{
			...
			System.out.println("Connected to database.");
			 ps=con.prepareStatement("select sid,sname from MyDatabase");
		    rs=ps.executeQuery();
    		while(rs.next())
    		{
    	     sid1=rs.getString(1);
       ...
       System.out.println(e);
        ...
        b0.setBounds(100,330,110,35);b0.setToolTipText("click to open medicine details");
		jf.add(b0);b0.addActionListener(this);

		b1 = new JButton("Update",new ImageIcon("images//update.png"));
		b1.setBounds(220,330,110,35);b1.setToolTipText("click to update medicine details");
	    jf.add(b1); b1.addActionListener(this);

        b2= new JButton("Clear",new ImageIcon("images//clear.png"));
		b2.setBounds(340,330,110,35);b2.setToolTipText("click to clear all textfields");
		jf.add(b2); b2.addActionListener(this);

    	b3 = new JButton("All",new ImageIcon("images//all.png"));
		b3.setBounds(460,330,110,35);b3.setToolTipText("click to view all medicine details");
		jf.add(b3); b3.addActionListener(this);

b4 = new JButton("Back",new ImageIcon("images//all.png"));
		b4.setBounds(580,330,110,35);b4.setToolTipText("click to go to Homepage");
 ...
 public void actionPerformed(ActionEvent ae)
  {
  	if(ae.getSource()==b0)
	  {
		...
		con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","system");
		System.out.println("Connected to database.");
			ps=con.prepareStatement("Select sid from DDDD where sname='"+s+"'");
    		  rs=ps.executeQuery();
    		  while(rs.next())
    		  {
		  ...
		  ps=con.prepareStatement("select * from MyDatabase where mname='"+t2.getText()+"' or mb='"+t1.getText()+"' ");
		  rs=ps.executeQuery();
		  while(rs.next())
	      {
...
String str1="UPDATE MyDatabase SET mbno='"+t1.getText()+"',mname='"+t2.getText()+"',mcompany='"+t3.getText()+"',mqty='"+t4.getText()+"',mexpdate='"+t5.getText()+"',mpurdate='"+t6.getText()+"',mtype='"+t7.getText()+"',mpurprice='"+t8.getText()+"',msaleprice='"+t9.getText()+"',mrackno='"+t10.getText()+"',sid='"+t12.getText()+"',sname='"+t11.getText()+"' where mbno='"+t1.getText()+"'or mname='"+t2.getText()+"'";
