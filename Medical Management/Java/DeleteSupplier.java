  ...
  l2.setBounds(150,160,170,25);
   ...
   l5.setBounds(150,280,170,25);
		...
		t5.setBounds(320,280,200,25);jf.add(t5);
		 ...
		 b0.setBounds(100,330,100,35);b0.setToolTipText("click to open supplier details");
	     jf.add(b0); b0.addActionListener(this);

	     b1 = new JButton("Delete",new ImageIcon("images//delete.png"));
		 b1.setBounds(220,330,100,35);b1.setToolTipText("click to delete supplier details");
		 jf.add(b1);b1.addActionListener(this);

		 b2 = new JButton("Clear",new ImageIcon("images//clear.png"));
		 b2.setBounds(340,330,100,35);b2.setToolTipText("click to clear all textfields");
		 jf.add(b2); b2.addActionListener(this);

     	b3 = new JButton("All",new ImageIcon("images//all.png"));
		b3.setBounds(460,330,100,35);b3.setToolTipText("click to view all supplier details");
		jf.add(b3); b3.addActionListener(this);


     	b4 = new JButton("Back",new ImageIcon("images//all.png"));
		b4.setBounds(580,330,100,35);
		b4.setToolTipText("click to go to Homepage");
		jf.add(b4); 
	...
	if(ae.getSource()==b0)
	 ...
	 {//delete
		...
		con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","system");
		System.out.println("Connected to database.");
	    ps=con.prepareStatement("delete from DDDD where sid='"+t1.getText()+"' or sname='"+t2.getText()+"'");
	    ps.executeUpdate();
